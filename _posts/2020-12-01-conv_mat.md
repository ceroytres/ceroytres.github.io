...
with corresponding eigenvector $f_v[n] = \frac{1}{\sqrt{L}}\exp{j2\pi vn/L}$. Note how the eigenvalues correspond to the Fourier transform values of $h[n]$ scaled by $\sqrt{L}$. This proof was modified version of the proof found in <a href="#ref_4">[4]</a>.  
